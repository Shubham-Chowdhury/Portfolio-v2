...
const achievements = [
  {
    ...
    desc: 'Earned Gold Badge recognition on HackerRank for demonstrated proficiency in problem solving and algorithmic logic.',
    date: 'Verified',
  },
  {
    icon: SiGithub,
    ...
    desc: 'Successfully unlocked all developer achievement badges on active GitHub profile.',
    date: 'Profile Honor',
  },
  {
    icon: Sparkles,
    title: 'IIT Guwahati — Alcheringa',
    category: 'Recognition / Participation',
    desc: 'Recognized participant at Alcheringa, the annual cultural and festival event hosted by IIT Guwahati.',
